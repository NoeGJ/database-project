...
const createStudent = (req, res) => {
    ...
    const { name, folio, age, gender, code, career, ingreso, egreso } = student
    ...
    .then( () => db.one('INSERT INTO estatus (titulado, inicio_titulacion, fin_titulacion, calificacion, id_mod1) VALUES ($1, $2, $3, $4, $5) returning id_estatus', 
      [graduated, startDate, endDate, average, id_mod])
        ...
        [code, folio, name,  gender, age , career, ingreso, egreso, id_estatus])
        .then(() => {
         console.log("success");
         res.status(201).json({
             message: "success",
...
const updateStudent = ( req, res ) => {
    ...
    [folio, name, gender, age, career, ingreso, egreso, code]) )
